    ...
    <body>
        ...
        <section>
            ...
            <div class="objects-container">
              <form method="post" action="/console/users/edit/<?= $user->id ?>" novalidate class="form">
                  <?= csrf_field() ?>
                  <div class="form__field">
                      <label for="first" class="form__label">First Name:</label>
                      <input type="text" class="form__input" name="first" id="first" value="<?= old('first', $user->first) ?>" required>
                  ...
                  <div class="form__field">
                      ...
                      <input type="text" class="form__input" name="last" id="last" value="<?= old('last', $user->last) ?>" required>
                  ...
                  <div class="form__field">
                      ...
                      <input type="email" class="form__input" name="email" id="email" value="<?= old('email', $user->email) ?>">
                  ...
                  <button type="submit" class="form__button">Edit User</button>
              </form>
            </div>
