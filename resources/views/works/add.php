        ...
        <section class="w3-padding">
            ...
            <form method="post" action="/console/works/add" novalidate class="w3-margin-bottom">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="text" name="employment_type" id="employment_type" value="<?= old('employment_type') ?>" required>
                ...
                <button type="submit" class="w3-button w3-green">Add Work Experience</button>
