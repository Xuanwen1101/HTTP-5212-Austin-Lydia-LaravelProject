...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <section class="w3-padding">
            ...
            <form method="post" action="/console/schools/edit/<?= $school->id ?>" novalidate class="w3-margin-bottom">

                <?= csrf_field() ?>

                <div class="w3-margin-bottom">
                    <label for="school">School:</label>
                    <input type="text" name="school" id="school" value="<?= old('school', $school->school) ?>" required>
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="url" name="school_url" id="school_url" value="<?= old('school_url', $school->school_url) ?>">
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="text" name="major" id="major" value="<?= old('major', $school->major) ?>" required>
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="text" name="degree" id="degree" value="<?= old('degree', $school->degree) ?>" required>
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="date" name="start_date" id="start_date" value="<?= old('start_date', $school->start_date) ?>" required>
                ...
                <div class="w3-margin-bottom">
                    ...
                    <input type="date" name="end_date" id="end_date" value="<?= old('end_date', $school->end_date) ?>" required>
