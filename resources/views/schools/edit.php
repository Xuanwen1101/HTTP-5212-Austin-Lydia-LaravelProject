    ...
    <body>
        ...
        <section>
            ...
            <div class="objects-container">
              <form method="post" action="/console/schools/edit/<?= $school->id ?>" novalidate class="form">
                  <?= csrf_field() ?>
                  <div class="form__field">
                      <label for="school" class="form__label">School:</label>
                      <input type="text" class="form__input" name="school" id="school" value="<?= old('school', $school->school) ?>" required>
                  ...
                  <div class="form__field">
                      ...
                      <input type="url" class="form__input" name="school_url" id="school_url" value="<?= old('school_url', $school->school_url) ?>">
                  ...
                  <div class="form__field">
                      ...
                      <input type="text" class="form__input" name="major" id="major" value="<?= old('major', $school->major) ?>" required>
                  ...
                  <div class="form__field">
                      ...
                      <input type="text" class="form__input" name="degree" id="degree" value="<?= old('degree', $school->degree) ?>" required>
                  ...
                  <div class="form__field">
                      ...
                      <input type="date" class="form__input" name="start_date" id="start_date" value="<?= old('start_date', $school->start_date) ?>" required>
                  ...
                  <div class="form__field">
                      ...
                      <input type="date" class="form__input" name="end_date" id="end_date" value="<?= old('end_date', $school->end_date) ?>" required>
                  ...
                  <button type="submit" class="form__button">Edit Education</button>
              </form>
            </div>
